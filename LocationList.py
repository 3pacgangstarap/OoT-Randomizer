...
#    ("Dodongos Cavern Side Room Before Lower Lizalfos Grass",        ("Grass",        0x01,  (11,0,4), None,                        'Rupees (5)',                            ("Dodongo's Cavern", "Vanilla Dungeons", "Grass"))),
    ...
    #("Spirit Temple Adult Climb Wallmaster",                         ("EnemyDrop",    0x06,  (15,0, 9), None,                    'Rupees (5)',                           ("Spirit Temple", "Vanilla", "EnemyDrop"))), you only get one chance to kill this enemy, and it's possible to soft lock if you miss it. commenting it out until this is fixed
    ...
    #("Spirit Temple MQ Central Chamber Zeldas Lullaby Wallmaster",   ("EnemyDrop",    0x06,  (5,0,21), None,                        'Rupees (5)',                                ("Spirit Temple", "Master Quest", "EnemyDrop"))), you only get one chance to kill this enemy, and it's possible to soft lock if you miss it. commenting it out until this is fixed

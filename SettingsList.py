        ...
        disable        = {
            True: {
                ...
                'settings': [
                    ...
                    'shuffle_boulders', 'shuffle_dungeon_rewards', 'shuffle_mapcompass',
                    'shuffle_smallkeys', 'shuffle_hideoutkeys', 'shuffle_tcgkeys', 'key_rings_choice',
                    'key_rings', 'keyrings_give_bk', 'shuffle_bosskeys', 'shuffle_silver_rupees',
                    'silver_rupee_pouches_choice', 'silver_rupee_pouches', 'enhance_map_compass',
                ],
            },
        },
        shared         = True,
